...
import { FaCar, FaHeart, FaShoppingCart, FaStar } from "react-icons/fa";
            ...
            >
              <Row>
                <Col className="p-3" md={6} lg={6} sm={12} xs={12}>
                  <img className="w-100" src={Product1} alt="pra" />
                  <Container className="my-3">
                    <Row>
                      <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3}>
                        <img className="w-100" alt="produk 12" src={Product1} />
                      </Col>
                      <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3}>
                        <img className="w-100" alt="produk 12" src={Product2} />
                      </Col>
                      <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3}>
                        <img className="w-100" alt="produk 12" src={Product3} />
                      </Col>
                      <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3}>
                        <img className="w-100" alt="produk 12" src={Product4} />
                      </Col>
                    </Row>
                  </Container>
                </Col>
